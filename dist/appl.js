...
$__System.register("73", [], function() { return { setters: [], execute: function() {} } });
...
$__System.register('75', ['73', '74', '4d'], function (_export) {
  'use strict';
            ...
            ProjectGrid = Vue.extend({
                ...
                methods: {
                    ...
                    class_for: function class_for(provider, requirement) {
                        ...
                        var provider_count_by_scores = providers_scores.reduce(function (carry, i) {
                        ...
                        var decending_scores = _Object$keys(provider_count_by_scores) // Get all scores
                        .map(function (k) {
                            return parseFloat(k);
                        }) // Make them floats
                        .sort(function (a, b) {
                    ...
                    save_comment: function save_comment(requirement_id, comment) {
                        var _this3 = this;
                ...
                computed: {
                    remaining_providers: function remaining_providers() {
                        ...
                        if (this.scorecard.providers && this.store.providers) {
                            ...
                            return this.store.providers.filter(function (p) {
                                return selected_providers_ids.indexOf(p.id) == -1;
                            });
                        }
                    },
                    ...
                    scorecard: function scorecard() {
                        ...
                        if (this.store && this.store.projects && proj_id) return this.store.projects.find(function (p) {
                            return p.id == proj_id;
                        });
                        if (this.store && this.store.projects && zoho_id) return this.store.projects.find(function (p) {
                ...
                watch: {
                    'selected.provider': function selectedProvider(provider) {
                        if (provider) {
                    ...
                    'selected.requirement': function selectedRequirement(requirement) {
                        if (requirement) {
...
$__System.register("7c", [], function (_export) {
  /*\
  |*|
  |*|  :: cookies.js ::
  |*|
...
$__System.register("7d", ["51", "52", "7c"], function (_export) {
...
$__System.register("1", ["5", "6", "7", "8", "72", "75", "78", "4d", "7b", "7d"], function (_export) {
	"use strict";

	var VueRouter, Vue, ProjectGrid, Control, Foo, router;
	return {
		setters: [function (_) {}, function (_2) {}, function (_3) {}, function (_4) {}, function (_5) {
			VueRouter = _5["default"];
		}, function (_6) {}, function (_7) {}, function (_d) {
			Vue = _d["default"];
		}, function (_b) {
			ProjectGrid = _b["default"];
		}, function (_d2) {
			Control = _d2["default"];
		}],
		execute: function () {
