        ...
        execute: function () {
            ...
            _export('default', Vue.extend({
                ...
                methods: {
                    ...
                    save_comment: function save_comment(requirement_id, comment) {
                        ...
                        if (this.selected.comment_type) {
                            ...
                            this.$root.control.send("update_comment", payload, function (request, response) {
                                ...
                                if (close) _this3.select_comment_type(null);
                            });
                        }
                    },
                    ...
                    select_comment_type: function select_comment_type(selection) {
...
$__System.register("1", ["5", "6", "7", "8", "72", "75", "78", "4d", "7b", "7d"], function (_export) {
	...
	var VueRouter, Vue, ProjectGrid, Control, router;
	return {
