...
(function(process) {
  (function(global, factory) {
    ...
    initGlobalAPI(Vue$3);
    Object.defineProperty(Vue$3.prototype, '$isServer', {get: function() {
    ...
    function isStatic(node) {
      ...
      return !!(node.pre || (!node.hasBindings && !node.if && !node.for && !isBuiltInTag(node.tag) && isPlatformReservedTag(node.tag) && Object.keys(node).every(isStaticKey)));
    }
